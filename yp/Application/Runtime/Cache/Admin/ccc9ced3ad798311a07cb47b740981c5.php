    ...
    <div class="container-fluid" >
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <ol class="breadcrumb">
            <li>
              <i class="fa fa-dashboard"></i>  <a href="/tyhcms/admin.php?c=content">文章管理</a>
            </li>
            <li class="active">
      ...
      <div class="row">
        <form action="/tyhcms/admin.php" method="get">
          <div class="col-md-3">
...
<script>
  var SCOPE = {
    'edit_url' : '/tyhcms/admin.php?c=content&a=edit',
    'add_url' : '/tyhcms/admin.php?c=content&a=add',
    'set_status_url' : '/tyhcms/admin.php?c=content&a=setStatus',
    'sing_news_view_url' : '/tyhcms/index.php?c=view',
    'listorder_url' : '/tyhcms/admin.php?c=content&a=listorder',
    'push_url' : '/tyhcms/admin.php?c=content&a=push',
  }
</script>
