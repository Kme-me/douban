  ...
  <!-- /.navbar-collapse -->
		...
		<div id="page-wrapper">
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-12">
						...
						<ol class="breadcrumb">
							<li>
								<i class="fa fa-dashboard"></i> <a href="/tyhcms/admin.php?c=menu">菜单管理</a>
							</li>
							<li class="active">
              ...
              <div class="col-sm-5">
                <select class="form-control" name="school_nj">
                  <option value="">==请选择年级==</option>
                      <?php if(is_array($school_nj)): foreach($school_nj as $key=>$nj): ?><option value="<?php echo ($key); ?>"><?php echo ($nj); ?></option><?php endforeach; endif; ?>
                </select>
              </div>
            </div>
              ...
              <div class="col-sm-5">
                <select class="form-control" name="school_km">
                  <option value="">==请选择科目==</option>
                      <?php if(is_array($school_km)): foreach($school_km as $key=>$km): ?><option value="<?php echo ($key); ?>"><?php echo ($km); ?></option><?php endforeach; endif; ?>
                </select>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <input type="text" name="school_ls" class="form-control" id="inputname" placeholder="请填写老师姓名">
              </div>
            </div>
            <div class="form-group">
              <label for="inputname" class="col-sm-2 control-label">课题:</label>
              <div class="col-sm-5">
                <input type="text" name="school_kt" class="form-control" id="inputname" placeholder="请填写课题">
              </div>
            </div>
							<div class="form-group">
                ...
                <input id="file_upload_image" name="thumb" type="hidden" multiple="true" value="">
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									...
									<input id="file_upload_video_url" name="vurl" type="hidden" multiple="true" value="">
	...
	<script>
		var SCOPE = {
			'save_url': '/6x/admin.php?c=video&a=add',
