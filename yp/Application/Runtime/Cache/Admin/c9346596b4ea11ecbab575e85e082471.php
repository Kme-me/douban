    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <ol class="breadcrumb">
            <li>
              <i class="fa fa-dashboard"></i>  <a href="/6x/admin.php/admin.php?c=content">文章管理</a>
            </li>
            <li class="active">
...
<script>
  var SCOPE = {
    'save_url' : '/tyhcms/admin.php?c=content&a=add',
    'jump_url' : '/tyhcms/admin.php?c=content',
    'ajax_upload_image_url' : '/tyhcms/admin.php?c=image&a=ajaxuploadimage',
...
<script>
  ...
  KindEditor.ready(function(K) {
    window.editor = K.create('#editor_singcms',{
      uploadJson : '/tyhcms/admin.php?c=image&a=kindupload',
