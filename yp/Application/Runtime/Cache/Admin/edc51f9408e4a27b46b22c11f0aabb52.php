...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
  ...
  <!-- /.navbar-collapse -->
	...
	<form class="form-horizontal" id="singcms-form" action=" " >
							<!--
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <select class="form-control" name="school_nj" >
                    <option value="">==请选择年级==</option>
                      <?php if(is_array($school_nj)): foreach($school_nj as $key=>$nj): ?><option value="<?php echo ($key); ?>" <?php echo ($info['school_nj'] == $key ? "selected=selected" : ""); ?>><?php echo ($nj); ?></option><?php endforeach; endif; ?>
                </select>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <select class="form-control" name="school_km">
                  <option value="">==请选择科目==</option>
                      <?php if(is_array($school_km)): foreach($school_km as $key=>$km): ?><option value="<?php echo ($key); ?>" <?php echo ($info['school_km'] == $key ? "selected=selected" : ""); ?>><?php echo ($km); ?></option><?php endforeach; endif; ?>
                </select>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <input type="text" name="school_ls" class="form-control" id="inputname" placeholder="请填写老师姓名" value="<?php echo ($info["school_ls"]); ?>">
              </div>
            </div>
            <div class="form-group">
              <label for="inputname" class="col-sm-2 control-label">课题:</label>
              <div class="col-sm-5">
                <input type="text" name="school_kt" class="form-control" id="inputname" placeholder="请填写课题" value="<?php echo ($info["school_kt"]); ?>">
              </div>
            </div>
			<div class="form-group">
                ...
                <img style="display: none" id="upload_org_code_img" src="" width="640" height="480">
                <input id="file_upload_image" name="thumb" type="hidden" multiple="true" value="<?php echo ($info["thumb"]); ?>">
				...
				<div class="form-group">
					<label for="inputname" class="col-sm-2 control-label">视频:</label>
					<div class="col-sm-5">
						<input id="video_upload" type="file" multiple="true">
						<video style="display: none" id="upload_code_video" src="" width="640" height="480" controls="controls" preload="none" controls="controls"></video>
						<input id="file_upload_video_url" name="vurl" type="hidden" multiple="true" value="<?php echo ($info["vurl"]); ?>">
